...
namespace abalone_core
{
	...
	const CellState VALID_BOARD[kNumRows][kNumCols] = {
		// 1				            2				              3				              4				              5				              6				              7				              8				              9
		{ CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Invalid }, // a
		{ CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Invalid, CellState::Invalid, CellState::Invalid },   // b
		{ CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Invalid, CellState::Invalid },     // c
		{ CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Invalid },       // d
		{ CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty },         // e
		{ CellState::Invalid, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty },       // f
		{ CellState::Invalid, CellState::Invalid, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty },     // g
		{ CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty },   // h
		{ CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty }, // i
	};

	const CellState ABALONE_INIT_CLASSIC[kNumRows][kNumCols] = {
		// 1				            2				              3				              4				              5				              6				              7				              8				              9
		{ CellState::Player0, CellState::Player0, CellState::Player0, CellState::Player0, CellState::Player0, CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Invalid }, // a
		{ CellState::Player0, CellState::Player0, CellState::Player0, CellState::Player0, CellState::Player0, CellState::Player0, CellState::Invalid, CellState::Invalid, CellState::Invalid }, // b
		{ CellState::Empty, CellState::Empty, CellState::Player0, CellState::Player0, CellState::Player0, CellState::Empty, CellState::Empty, CellState::Invalid, CellState::Invalid },         // c
		{ CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Invalid },                 // d
		{ CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty },                   // e
		{ CellState::Invalid, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty },                 // f
		{ CellState::Invalid, CellState::Invalid, CellState::Empty, CellState::Empty, CellState::Player1, CellState::Player1, CellState::Player1, CellState::Empty, CellState::Empty },         // g
		{ CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Player1, CellState::Player1, CellState::Player1, CellState::Player1, CellState::Player1, CellState::Player1 }, // h
		{ CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Player1, CellState::Player1, CellState::Player1, CellState::Player1, CellState::Player1 }, // i
	};

	const CellState ABALONE_INIT_BELGIAN_DAISY[kNumRows][kNumCols] = {
		// 1				            2				              3				              4				              5				              6				              7				              8				              9
		{ CellState::Player0, CellState::Player0, CellState::Empty, CellState::Player1, CellState::Player1, CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Invalid },   // a
		{ CellState::Player0, CellState::Player0, CellState::Player0, CellState::Player1, CellState::Player1, CellState::Player1, CellState::Invalid, CellState::Invalid, CellState::Invalid }, // b
		{ CellState::Empty, CellState::Player0, CellState::Player0, CellState::Empty, CellState::Player1, CellState::Player1, CellState::Empty, CellState::Invalid, CellState::Invalid },       // c
		{ CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Invalid },                 // d
		{ CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty },                   // e
		{ CellState::Invalid, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty, CellState::Empty },                 // f
		{ CellState::Invalid, CellState::Invalid, CellState::Empty, CellState::Player1, CellState::Player1, CellState::Empty, CellState::Player0, CellState::Player0, CellState::Empty },       // g
		{ CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Player1, CellState::Player1, CellState::Player1, CellState::Player0, CellState::Player0, CellState::Player0 }, // h
		{ CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Invalid, CellState::Player1, CellState::Player1, CellState::Empty, CellState::Player0, CellState::Player0 },   // i
	};


	void core_state::Reset(const CellState _init_pattern[kNumRows][kNumCols] /*= ABALONE_INIT_CLASSIC*/)
	{
	...
	std::ostream& operator<<(std::ostream& _os, core_state const& _arg)
	{
		...
		auto display_line = [&](std::string prefix, int row, int start, int end, std::string postfix)
		{
			_os << prefix;
	...
	bool Move::IsValid(const core_state& _state) const
	{
		...
		auto opponent = player == CellState::Player0 ? CellState::Player1 : CellState::Player0;
		...
		if (line_content[1] == player && line_content[2] == opponent && (line_content[3] == CellState::Invalid || line_content[3] == CellState::Empty))  // 2VS1
			return true;

		if (line_content[1] == player && line_content[2] == player && line_content[3] == CellState::Empty)
			return true;
		//if (line_content[1] == player && line_content[2] == player && line_content[3] == CellState::Invalid)
		//	return false;

		if (line_content[1] == player && line_content[2] == player && line_content[3] == opponent && (line_content[4] == CellState::Invalid || line_content[4] == CellState::Empty))  // 3VS1
			return true;
		...
		if (line_content[1] == player &&
			...
			(line_content[5] == CellState::Invalid || line_content[5] == CellState::Empty)
			)  // 3VS2
			return true;
	...
	*/
	void Move::_ApplyParallelMove(core_state& _state, int _dr, int _dc) const
	{
		...
		for (int i = 0; i <= size; i++)
		{
			...
			if (nextId != CellState::Empty)  // we could slide on kEmpty cells and own cells
				break;
